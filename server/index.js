...
function socialLinksHtml(footer = false) {
  ...
  return `<nav class="${cls}" aria-label="Social profiles"><a class="social-link" href="https://github.com/chkp-bryans" target="_blank" rel="noopener" aria-label="GitHub"><span class="social-icon social-icon-github" aria-hidden="true"></span></a><a class="social-link" href="https://x.com/psuimpreza" target="_blank" rel="noopener" aria-label="X"><span class="social-icon social-icon-x" aria-hidden="true"></span></a><a class="social-link" href="https://www.instagram.com/psuimpreza/" target="_blank" rel="noopener" aria-label="Instagram"><span class="social-icon social-icon-instagram" aria-hidden="true"></span></a><a class="social-link" href="https://www.reddit.com/user/psuimpreza/" target="_blank" rel="noopener" aria-label="Reddit"><span class="social-icon social-icon-reddit" aria-hidden="true"></span></a></nav>`;
}
...
${ogImageMetaTags(post.cover, image)}
  ...
  <link rel="stylesheet" href="/css/styles.css?v=social2">
  ${goatCounterSnippet()}
</head>
